...
Top Level file is LEON3_DE1.v
Quartus Project file is LEON3_DE1_quartus.qpf
Synthesis can be triggered using command "make quartus" 

Pin Mapping:

| FAMEv2 pin    | Function                               | DE1 pin function |
|---------------|----------------------------------------|------------------|
| resetn        | Global Reset                           | KEY[3]           |
| clk           | Input clock                            | CLOCK_50         |
| alarmout      | Alarm Out from leon3 if fault detected | GPIO[18]         |
| DebugUart_RX  | AHBUART receive                        | GPIO[35],LEDR[5] |
| DebugUart_TX  | AHBUART transmit                       | GPIO[33],LEDR[4] |
| PeriphUart_RX | APBUART receive                        | GPIO[29],LEDR[7] |
| PeriphUart_TX | APBUART transmit                       | GPIO[31],LEDR[6] |
| dsuact        | Check if DSU is active                 |                  |
| dsubre        | External Break signal for DSU          | SW[8]            |
