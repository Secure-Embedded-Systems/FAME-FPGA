...
//      comment:		
//      configuration:	 -instname sram9x32 -words 512 -bits 32 -frequency 100 -ring_width 2 -mux 16 -drive 12 -write_mask off -wp_size 8 -top_layer met6 -power_type rings -horiz met3 -vert met4 -cust_comment "" -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND
//
//      Verilog model for Synchronous Single-Port Ram
//
//      Instance Name:  sram9x32
//      Words:          512
//      Word Width:     32
//      Pipeline:       No
//
//      Creation Date:  2016-07-05 15:16:25Z
//      Version: 	r15p0-01eac0
//
